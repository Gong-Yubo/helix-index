...
| [`devel/plan-v2.md`](./devel/plan-v2.md)（V2 开发计划） | **V2 任务清单与进度**：V2.0 = Step 1~7，V2.1 = Step 8~10（`plan.md` 冻结为 V1 计划）。⚠️ **2026-09-07 重排**：Step 3 起编号已变（旧号→新号见文末 §附-2 映射表） | 实现者（V2 开工先看这个） |
| [`devel/plan-v2-review.md`](./devel/plan-v2-review.md)（V2 计划复审） | **2026-09-07 全量复审**：7 处调整（A1~A7）+ 4 个拍板问题（D1~D4）及结论，含 fastembed / ort 的源码级核实证据 | 决策者、评审者 |
