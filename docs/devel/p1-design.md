...
- 示例语料：手写 **~30 篇**中文短文档（Rust / 检索 / BM25 / 向量 / 分词主题），每篇 300~800 字
  - ⚠️ 这是**冒烟语料不是评测语料**。P5 需要的 50~200 篇真实语料另需准备（T5-01）
...
| D6  | **示例语料规模**                | P1 手写 **~30 篇**短文档作为冒烟语料；P5 的评测语料（50~200 篇真实文档）另行准备                                                                                    | 30 篇只够冒烟，不足以得出任何效果结论                     |
...
- `data/corpus.jsonl` 是 30 篇**冒烟语料**，P5 需 50~200 篇真实语料（T5-01）
