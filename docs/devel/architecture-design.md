...
| 文档版本 | v1.12                |
| 创建日期 | 2026-09-02           |
| 状态   | **V2.0 Step 1~5 已并入 `main`**（Step 5 收尾 = PR #37 → `590315d`，2026-09-11）；**Step 6 详细设计已出、实现未开工**（`v2-step6-design.md` v0.1，D-S6-01~09 待评审；本版新增 §14.4 R36~R40）；Step 7 未开工。步骤编号映射见 `plan-v2.md` §附-2 |
